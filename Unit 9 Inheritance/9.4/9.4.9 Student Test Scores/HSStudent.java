public class HSStudent extends StudentTest {
    ...
    public boolean gradQualify(){
        if(this.completeService() && this.passEla() && this.passMath()) return true;
        return false;
    }
